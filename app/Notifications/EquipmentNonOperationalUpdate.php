...
class EquipmentNonOperationalUpdate extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mailMessage->subject('('.$this->equip->name.') Equipment Non-Operational');
        $mailMessage->line('Equipment Name '. $this->equip->name.' and LM No.:'. $this->equip->lm_no. ' is now NON-OPERTAIONAL.');
