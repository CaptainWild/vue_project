...
<div>
  ...
  >
    <template v-slot:top>
      ...
      <template v-slot:item.responded>
        <v-chip class="ma-2" color="info">{{0}}</v-chip>/
        <v-chip class="ma-2" color="error">{{0}}</v-chip>            
      </template>
    ...
    <v-dialog
      ...
      <!-- <template v-slot:item.responded>
          <v-chip class="ma-2" color="info">{{0}}</v-chip>/
          <v-chip class="ma-2" color="error">{{1}}</v-chip>            
      </template> -->
...
export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'Last Review Date', value: 'last_review_date' },
        { text: 'Next Review Date', value: 'next_review_date' },
    ...
    methods: {
      initialize () {
        ...
        this.desserts = [
          {
            name: 'Project P001',
            assessment_date: '01/02/2020',
            last_review_date: '12/02/2020',
            next_review_date: '11/02/2020',
            // protein: 4.0,
            // <v-chip class="ma-2" color="info">{{}}</v-chip>/
            // <v-chip class="ma-2" color="error">{{}}</v-chip>  
          },
          {
            name: 'Project P002',
            assessment_date: '03/01/2020',
            last_review_date: '15/01/2020',
            next_review_date: '14/04/2020',
            // protein: 4.3,
          },
          {
            name: 'Project P003',
            assessment_date: '21/02/2020',
            last_review_date: '25/02/2020',
            next_review_date: '24/05/2020',
            // protein: 6.0,
          },
          {
            name: 'Project P004',
            assessment_date: '11/03/2020',
            last_review_date: '15/03/2020',
            next_review_date: '21/06/2020',
            // protein: 4.3,
          },
          {
            name: 'Project P005',
            assessment_date: '15/02/2020',
            last_review_date: '15/03/2020',
            next_review_date: '15/04/2020',
            // protein: 3.9,
          },
          {
            name: 'Project P006',
            assessment_date: '14/02/2020',
            last_review_date: '17/02/2020',
            next_review_date: '19/04/2020',
            // protein: 0.0,
          },
          {
            name: 'Project P007',
            assessment_date: '18/01/2020',
            last_review_date: '20/03/2020',
            next_review_date: '20/07/2020',
            // protein: 0,
          },
          {
            name: 'Project P008',
            assessment_date: '21/02/2020',
            last_review_date: '17/03/2020',
            next_review_date: '13/05/2020',
            // protein: 6.5,
          },
          {
            name: 'Project P009',
            assessment_date: '11/04/2020',
            last_review_date: '12/04/2020',
            next_review_date: '21/05/2020',
            // protein: 4.9,
          },
          {
            name: 'Project P010',
            assessment_date: '27/03/2020',
            last_review_date: '01/04/2020',
            next_review_date: '12/06/2020',
            // protein: 7,
          },
        ]
      },
